...
return new class extends Migration // Début de la définition de la migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('panier', function (Blueprint $table) { // Création de la table 'panier'
            ...
            $table->foreignId('utilisateur_id')->constrained('utilisateur')->onDelete('cascade'); // Création de la colonne 'utilisateur_id' comme clé étrangère vers la table 'utilisateur'. Si l'utilisateur est supprimé, le panier sera également supprimé.
